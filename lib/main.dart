                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      child: Icon(isOngoing ? LucideIcons.shoppingBag : LucideIcons.check, size: 48, color: AppColors.coral),
                    ),
                    const SizedBox(height: 32),
                    Text(
                      isOngoing ? "You don't have any upcoming deliveries!" : 'No completed deliveries yet',
                      textAlign: TextAlign.center,
                      style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: AppColors.navy),
                    ),
                    const SizedBox(height: 12),
                    Text(
                      isOngoing ? 'Join the adventure and make your first delivery ;)' : 'Your delivery history will show up here',
                      textAlign: TextAlign.center,
